package ru.kanogor.skillcinema.presentation.adapters.gallery.paging_cover
...
class CoverPicturesPagingSource(private val repository: FilmRepository, val filmId: Int) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, GalleryPicture> {
        ...
        return kotlin.runCatching {
            repository.getCoverPictures(filmId, page)
        }.fold(
            onSuccess = {
                LoadResult.Page(
                    data = it.items,
