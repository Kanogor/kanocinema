package ru.kanogor.skillcinema.presentation.adapters.gallery.paging_screenshot
...
class ScreenshotPicturesPagingSource(private val repository: FilmRepository, val filmId: Int) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, GalleryPicture> {
        ...
        return kotlin.runCatching {
            repository.getScreenshotPictures(filmId, page)
        }.fold(
            onSuccess = {
                LoadResult.Page(
                    data = it.items,
